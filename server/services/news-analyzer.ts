...
const POSITIVE_KEYWORDS = [
  ...
  '기관투자', '제도화', 'ETF승인', 'ETF허용', '상장승인', '거래허용', '규제완화정책',
  '정책완화', '규제개선', '법적승인', '정부승인', '금융당국승인', '금융혁신', '핀테크발전',
  '블록체인발전', '암호화폐합법', '디지털자산', '투자환경개선', '시장개방', '투자기회',
  '제도적지원', '정책지원', '규제샌드박스', '혁신금융', 'DeFi발전', 'NFT붐', '메타버스',
  '가상자산', '디지털화폐', '중앙은행디지털화폐', 'CBDC', '결제수단', '법정화폐',
  '글로벌채택', '대기업투자', '기업도입', '페이팔', '테슬라', '마이크로스트래티지',
  '엘살바도르', '비트코인법정화폐', '국가차원도입', '정부지원', '세제혜택',
  // 정치 (대폭 확장)
...
const NEGATIVE_KEYWORDS = [
  ...
  // 가상화폐/비트코인 악재 (대폭 확장)
  '규제강화', '규제 강화', '강화', '금지', '불법화', '거부', '차단', '제재',
  '악재', '부정적', '비관적', '우려', '위험성', '불안정', '투기', '버블',
  '폭락위험', '투자주의', '투자경고', '손실위험', '변동성', '불확실성',
  '해킹', '보안사고', '거래소폐쇄', '사기', '스캠', '폰지사기', '러그풀',
  '규제당국경고', '금융당국우려', '중앙은행반대', '정부반대', '법적문제',
  '자금세탁', '불법거래', '범죄악용', '테러자금', '탈세', '음성거래',
  '환경파괴', '전력소모', '채굴금지', '친환경논란', '에너지낭비',
  '시장조작', '펌프앤덤프', '고래매도', '대량매도', '패닉셀링',
  '중국금지', '인도금지', '터키금지', '각국규제', '국제공조',
  '세금폭탄', '중과세', '양도소득세', '거래세', '과세강화',
  // 정치 (대폭 확장)
...
export class NewsAnalyzer {
  ...
  private enhanceScoreBasedOnKeywords(text: string, baseScore: number): number {
    ...
    const FIELD_POSITIVE = [
      ...
      // 가상화폐/비트코인 초강력 호재 키워드
      '가상화폐규제완화', '비트코인호재', '암호화폐합법화', '가상자산ETF승인', '비트코인ETF',
      '규제완화정책', '가상화폐허용', '디지털자산승인', '블록체인정책', '암호화폐도입',
      '가상화폐투자', '비트코인투자', '디지털화폐정책', '핀테크혁신', '가상자산제도화',
      '비트코인법정화폐', '가상화폐결제', '암호화폐결제', '블록체인도입', '디지털자산투자',
      '가상화폐세제혜택', '비트코인세금완화', '암호화폐거래소승인', '가상자산거래허용',
      '비트코인선물', '가상화폐파생상품', '암호화폐기관투자', '디지털자산펀드',
      // 정치
    ...
    const FIELD_NEGATIVE = [
      ...
      // 가상화폐/비트코인 초강력 악재 키워드
      '가상화폐규제강화', '비트코인악재', '암호화폐불법화', '가상자산금지', '비트코인금지',
      '규제강화정책', '가상화폐차단', '디지털자산제재', '블록체인규제', '암호화폐단속',
      '가상화폐세금폭탄', '비트코인세금', '디지털화폐규제', '핀테크규제', '가상자산과세',
      '비트코인거래소폐쇄', '가상화폐해킹', '암호화폐사기', '블록체인보안사고', '디지털자산손실',
      '가상화폐폰지사기', '비트코인스캠', '암호화폐러그풀', '가상자산사기', '디지털화폐범죄',
      '비트코인환경논란', '가상화폐전력소모', '암호화폐채굴금지', '가상자산환경파괴',
      // 정치
