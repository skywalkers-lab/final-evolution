...
const POSITIVE_KEYWORDS = [
  ...
  // 법정/사법 긍정
  '무혈의', '불기소', '석방', '무죄', '예비구속기각', '공소시효', '재심승리', '항소기각', '재심기각',
  '수사종결', '수사중단', '성명회복', '명예회복', '정의구현', '법치확립', '청렴정치', '투명정치',
  // 안보/국방 긍정
  '안보강화', '국방력증강', '군비확충', '방위력강화', '전술개발', '대비책성공', '영토보전',
  '평화유지', '외침방어', '억지력확보', '전략무기', '방위체계', '안보협력', '방위동맹',
  // 사회
...
const NEGATIVE_KEYWORDS = [
  ...
  '계엄', '계엄령', '비상계엄', '내란', '내란죄', '내란음모', '내란선동', '외환', '외환죄', '국가기밀누설',
  '고소', '고발', '수사', '수사개시', '체포', '구속', '연결', '배후조종', '특검수사', '검찰수사',
  '탄핵', '탄핵소추', '탄핵과정', '전직대통령체포', '대통령직무정지', '궭력남용', '민주주의파괴',
  '반역', '반역죄', '쿠데타', '정변', '초법적', '굳이지', '전복', '체제전복', '사회전복', '헌정전복',
  // 범죄/비리 관련
  '비리', '부패', '대류비리', '회계조작', '횡령', '배임', '미담롱', '청탁', '롼비', '한랜당',
  '금전수수', '등급비리', '일간비리', '예산낭비', '발주비리', '대기업백지수표', '중간수수',
  // 외교/안보 위기
  '간첩', '스파이', '첫보', '이중첫보', '국가기밀누설', '기밀유출', '외교기밀누설', '군사기밀누설',
  '테러', '테러공격', '폭동', '소요', '시위', '대규모시위', '폭력시위', '과격진압', '육군투입',
  '전쟁', '침공', '도발', '군사도발', '전쟁위기', '무력충돌', '공습', '공습위협', '무력취진',
  // 사회
